...
The native launcher records the Streamlit PID under `%LOCALAPPDATA%\GroundedDocParse\runtime`; use the in-app managed shutdown control or stop that process. To stop WSL GPU services, run:
