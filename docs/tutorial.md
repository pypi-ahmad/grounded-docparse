...
7. For every engine except pure AI, enable **AI enhancement for failed or <75% confidence regions** only when remote repair is wanted. Enable document chat only if needed.
