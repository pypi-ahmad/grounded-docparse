...
7. For every engine except **AI ADE**, enable **AI enhancement for failed or <75% confidence regions** only when remote repair is wanted. Enable document chat only if needed.
