...
8. For extraction, Luna proposes an editable strict JSON Schema. Luna extracts values plus evidence; invalid or missing evidence triggers one Terra critic repair, after which unresolved values become `null` with warnings.
